...
public interface IRepository
{
    ...
    Task<ApiUser?> GetValidUserAsync(Guid userGuid, CancellationToken cancellationToken = default);
    ...
    Task<int> UpdateWordRating(Guid userGuid, Guid dictGuid, Guid wordGuid, RatingAction action, CancellationToken cancellationToken = default);
